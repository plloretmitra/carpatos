...
const sections = [
  {
    ...
    children: [
      ...
      empty(80),
      body("Tarde y noche: primer contacto con Bucarest. El barrio de Lipscani (el casco histórico) es el lugar ideal para una primera cerveza rumana (Ursus o Timișoreana) y una cena tranquila. El pasaje de cristal Macca-Villacrosse —de 1891, con su techo de vidrio amarillo— es uno de los rincones más fotogénicos de la ciudad."),
      empty(80),
      bullet("Paseo por el Boulevard Unirii (diseñado por Ceaușescu como versión rumana de los Champs-Élysées) para entender la ambición megalomaníaca del régimen."),
